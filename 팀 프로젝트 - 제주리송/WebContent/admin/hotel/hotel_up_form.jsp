...
<%
	...
	// ▼▼▼ 데이터 받아와서 변수 셋팅 ▼▼▼ 
	HotelInfo info = (HotelInfo) request.getAttribute("hotelInfo");
				...
				<table class="tbl_view01">
					...
					<tr> 
						...
						<td colspan="5">
							...
							<div class="photo">
								<img src="../common/images/HotelImg/<%= info.getHotel_img1() %>"  width="80px;" />
								<%= info.getHotel_img1() %>
							</div>
						</td>
					</tr>
					<tr> 
						...
						<% if(!common.isEmpty(info.getHotel_img2())) { %>
							<div class="photo">
								<img src="../common/images/HotelImg/<%=info.getHotel_img2() %>"  width="80px;" />
								<%= info.getHotel_img2() %>
							</div>
						<% } %>
						</td>
					...
					<tr> 
						...
						<% if(!common.isEmpty(info.getHotel_img2())) { %>
							<div class="photo">
								<img src="../common/images/HotelImg/<%= info.getHotel_img3() %>"  width="80px;" />
								<%= info.getHotel_img3() %>
							</div>
						<% } %>
						</td>
					...
					<tr>
						...
						<td>
							<input type="hidden" name="hd_del_yn" value="info.getHotel_del_yn()" />
					    <% for(String key : common.getDelYn().keySet()) { 
					    	String label = common.getDelYn().get(key);
					    	String chk = (key.equals(info.getHotel_del_yn())) ? "checked = 'checked'" : "";
					    %> 
							<div class="radio_my"> 
							    <input type="radio" id="rdo_del_<%=key %>" name="rdo_del_yn" value="<%=key%>" <%=chk %>/>
							    <label for="radio1"><%=label %></label>
						  	</div>
						<% } %>
