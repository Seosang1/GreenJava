...
<script>
	function onSubmit() {
		...
		if (frm.txt_cnt.value == "") {
			alert("방 개수를 입력해주세요");
			return false;
		}
		
		if (frm.txt_sNumber.value == "" || frm.txt_eNumber.value == "") {
			alert("생성할 방호수를 입력해주세요");
			return false;
		}
		
		if ( (frm.txt_eNumber.value - frm.txt_sNumber.value) > frm.txt_cnt.value) {
			alert("생성할 방호수는 방 개수를 넘지 않게 입력해주세요");
			return false; 
		}
	...
	// 호텔검색
	function findHotel() {
		var options = 'top=10, left=10, width=650, height=600, status=no, menubar=no, toolbar=no, resizable=no';
				...
				<table class="tbl_view01">
					...
					<tr>
						...
						<td colspan="5">
							...
							<span><input type="checkbox" name="chk_eq" id="eq<%=key%>" /></span>
					...
					<tr> 
						...
						<td> 
							<input class="disabled" type="text" name="txt_dis_price" value="900" disabled="" style="width:60px;">
						</td>
					</tr>
					<tr> 
					...
					<tr> 
						<th scope="row">방개수</th>
						<td>
							<span><input type="text" name="txt_cnt" onkeyup="onlyNum(this);" value="3" class="txtNum"></span>
						</td>
						<th scope="row">방호수</th>
						<td colspan="3">
							<span><input type="text" name="txt_sNumber" onkeyup="onlyNum(this);" value="1001" class="txtNum"></span> ~ 
							<span><input type="text" name="txt_eNumber" onkeyup="onlyNum(this);" value="1003" class="txtNum"></span>
						</td>
					</tr> 
					<tr>
