...
public class TestInfo { 
	private int cpage, pcnt, spage, epage, rcnt, psize, bsize, bn_idx, bn_read, bn_reply;
	private String  bn_pwd, bn_writer, bn_title, bn_content, bn_date, schtype, keyword;
	...
	public int getBn_reply() {
		return bn_reply;
	}
	public void setBn_reply(int bn_reply) {
