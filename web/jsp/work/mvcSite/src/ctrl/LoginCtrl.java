...
public class LoginCtrl extends HttpServlet {
	...
	// post방식으로 데이터를 보냈을 경우 동작하는 서블릿의 메소드
		...
		// 사용자에게 입력받은 아이디와 비밀번호를 인수로 하여 loginSvc 인스턴스의
		// getLoginMember() 메소드를 실행하고 그 결과를 MemberInfo형 인스턴스 loginMember에 저장
		// 받아온 loginMember 인스턴스에는 로그인한 회원의 정보들이 들어 있음
		// 단, 로그인 실패시 loginMember 인스턴스에는 null값이 들어있게 됨
