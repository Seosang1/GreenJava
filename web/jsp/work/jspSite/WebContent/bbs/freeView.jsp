...
#reply td { border-bottom:2px #efefef solid; }
</style>
<script>
...
<div id="reply" style="width:700px; height:60px; border:1px solid black; padding:5px;">
	<textarea name="rcontent" style="width:550px; height:50px; float:left;" 
	<% if (login_info == null) { %>onfocus="alert('로그인 후에 사용하실 수 있습니다.'); this.blur();"<% } %>><% if (login_info == null) { %>댓글 기능은 로그인 후에 사용할 수 있습니다.<% } %></textarea>
...
<td width="26%" align="right" valign="top">
	...
	<a href="javascript:<% if (isPms) { %>replyUp(<%=rs.getInt(1)%>);<% } else { %>alert('수정 권한이 없습니다.');<% } %>">[u]</a>
...
%>
<div id="reply" style="width:700px; height:60px; border:1px solid black; text-align:center;">
	<br />등록된 댓글이 없습니다.
</div>
<%
	}
