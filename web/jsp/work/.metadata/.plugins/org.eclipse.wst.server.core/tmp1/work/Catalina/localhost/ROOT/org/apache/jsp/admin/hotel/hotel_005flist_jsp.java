 ...
 * Generated at: 2021-06-21 05:59:23 UTC
...
for(String key : mapSchargs.keySet()) {
	schargs += "&"+key +"=" +  mapSchargs.get(key);
      ...
      out.write("\t\t\t\t\t\tif (chk_del[i].disabled == false) {\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t/* 삭제처리 */\r\n");
      out.write("\t\t\t\tfunction onProcDel(code) {\r\n");
      out.write("\t\t\t\t\tconsole.log(\"delete proc :\" + code); \r\n");
      out.write("\t\t\t\t\tvar arrCheck = []; \r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif (code == \"all\") {\r\n");
      out.write("\t\t\t\t\t\tvar chk_del = document.getElementsByName(\"chk_del\");\r\n");
      out.write("\t\t\t\t\t\tfor (var i = 0; i < chk_del.length; i++ ) {\r\n");
      out.write("\t\t\t\t\t\t\tif (chk_del[i].checked == true && chk_del[i].disabled == false) {\r\n");
      out.write("\t\t\t\t\t\t\t\tarrCheck[i] = chk_del[i].value;\r\n");
      out.write("\t\t\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\tarrCheck[0] = code; \r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t \r\n");
 ...
 for(String key : common.getOpenYn().keySet()) { 
      ...
      out.write("\t\t\t\t\t\t\t<a href=\"#\" onclick=\"onProcDel('all')\" class=\"btn_default gray\">삭제</a>\r\n");
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t\t\t<!-- *** list *** -->\r\n");
      ...
      out.write("</td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td><strong><a href=\"hotel_view.hotela?hotel_code=");
      out.print(hotelInfo.getHotel_code() );
      out.write('"');
      out.write('>');
 ...
 if(hotelInfo.getHotel_del_yn().equals("n")) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"button\" value=\"삭제\" onclick=\"onProcDel('");
      out.print(hotelInfo.getHotel_code() );
      out.write("')\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t");
 } else { 
